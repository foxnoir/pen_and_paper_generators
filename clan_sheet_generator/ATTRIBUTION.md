...
The generator code itself is open source and available under the MIT License (see LICENSE file in the parent directory).

## Disclaimer

This project is a fan-made tool and is not officially associated with White Wolf Entertainment AB, Paradox Interactive, or any official Vampire: The Masquerade products. All trademarks and copyrights belong to their respective owners.
